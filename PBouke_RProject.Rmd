...
Last but not least, despite a weak positive correlation in sincerity attribute among Asian/Pacific Islander Americans, Europen-Caucasion and Latino Americans, it is possible to mention the existence of a relatively strong negative correlation for the remaining two nations. What we can understand from this result is that, as sincerity was not among the most important parameters in partner selection at the beginning, in the end for those with negative correlation sincerity attribute did not played an important role also.
