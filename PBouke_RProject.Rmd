...
Therefore, the following charts can give an illustration about the main profile in the sample used for this dataset:
...
The participants were asked what they are looking for in the opposite sex before the dating event.  They evaluated 6 attributes:  attractive ('attr'), sincere ('sinc'), intellent ('intel'), fun ('fun'), ambitious ('amb'), and shared interests ('shar').  
...
From the plots and the correlation tests, where there is a match (decision to meet = 1), there is a positive but weak correlation for the Ambitious (Amb) attribute for both genders, with female placing a higher weightage for Ambitious compared to male.  However, in the plot where there is no match (decision to meet = 0), male showed that they are not meeting those who have lower Ambitious score than what they were looking for but the correlation is weak.  Female is not consistent here as they have rejected those who met their expectation but the correlation is also weak.  Other attributes may have played more strongly in their decisions.
...
Considering the correlation tests and scatter plots, both genders showed a positive but very weak correlation between what they wanted in their partners in terms of fun and what they eventually chose.  Similarly, there is a weak negative correlation in deciding not to meet a potential date.  In other words, both genders showed that they are rather consistent, thought weak in their choice of a potential date when the other party meets their desired level of fun.
...
```
Even when considered one of the most important parameters in partner selection, it is surprising that the attractive attribute has a weak positive correlation gradient when observing the participants from different ethnicities choose a partner. In contrast, when refusing, it gains a slightly more importance. Thus, not while choosing but while refusing attractiveness matters for people.
...
Last but not least, despite a weak positive correlation in sincerity attribute among Asian/Pacific Islander Americans, Europen-Caucasion and Latino Americans, it is possible to mention the existence of a relatively strong negative correlation for the remaining two nations. It can be understood from this result is that, as sincerity was not among the most important parameters in partner selection at the beginning, in the end for those with negative correlation sincerity attribute did not played an important role also.
...
In other words, if a woman walks in into a speed-dating event, she better be Jessica Alba-like: attractive, fun and intelligent (yes, she founded the Honest Company that is now worth more than $1B).
...
As a result, is time to review all the findings of this fictionnal fast-paced world where speed-dating is king.
